    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('formulation', models.CharField(max_length=200, unique=True, verbose_name='Формулировка')),
            ],
            options={
                'verbose_name': 'Ответ',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_answer', models.IntegerField(choices=[('Краткий ответ', 0), ('Развернутый ответ', 1), ('Один из списка', 2), ('Несколько из списка', 3), ('Дата', 4)], verbose_name='Тип ответа')),
                ('is_requried', models.BooleanField(choices=[('Да', True), ('Нет', False)], default=True, verbose_name='Обязательный вопрос')),
                ('answers', models.ManyToManyField(related_name='questions', to='present2web.Answer')),
            ],
            options={
                'verbose_name': 'Вопрос',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', djmoney.models.fields.MoneyField(decimal_places=2, default_currency='RUB', max_digits=6)),
                ('url', models.URLField(verbose_name='Ссылка на подарок')),
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='presents', to='present2web.category', verbose_name='Категория')),
                ('color', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='presents', to='present2web.color', verbose_name='Цвет')),
            ],
            options={
